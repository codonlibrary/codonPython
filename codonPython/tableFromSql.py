...
def tableFromSql(server, database, table_name, user="", password="", schema=None, index_col=None, coerce_float=True, parse_dates=None, columns=None, chunksize=None):
    '''Returns a SQL table in a DataFrame.
    
    Convert a table stored in SQL Server 2016 into a pandas dataframe. Requires the odbc driver for SQL Server.
    ...
    return pd.read_sql_table(table_name, engine, schema=None, index_col=None, coerce_float=True, parse_dates=None, columns=None, chunksize=None)